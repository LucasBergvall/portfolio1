...
import { UserOutlined, LockOutlined, MailOutlined, PhoneOutlined, HomeOutlined, BookOutlined, RobotOutlined } from '@ant-design/icons';
import './JoinPage.css';
    ...
    <div className="join-page-wrapper">
      <div className="logo-wrapper" onClick={goHome}>
        <div className="logo-text">
          <BookOutlined style={{ fontSize: '48px', color: '#000000' }} />서적마켓
        </div>
      </div>
